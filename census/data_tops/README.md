...
These are the first 100 rows of each dataset from the U.S. Census Bureau.
...
More information, and the raw data, can be found at [data.census.gov](https://data.census.gov/table?q=2023%20C16001%20Detailed%20Language%20Spoken%20at%20Home%20for%20the%20Population%205%20Years%20and%20Over%20Counties).


## Census Dataset Schemas
